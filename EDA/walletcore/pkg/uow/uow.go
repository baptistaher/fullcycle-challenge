...
type UowInterface interface {
	...
	GetRepositroy(ctx context.Context, name string) (interface{}, error)
...
func (u *Uow) GetRepositroy(ctx context.Context, name string) (interface{}, error) {
	if u.Tx == nil {
...
func (u *Uow) Do(ctx context.Context, fn func(Uow *Uow) error) error {
	...
	if err != nil {
		errRb := u.Rollback()
		if errRb != nil {
			// return errors.New(fmt.Sprintf("original error: %s, rollback error: %s", err.Error(), errRb.Error()))						// return errors.New(fmt.Sprintf("original error: %s, rollback error: %s", err.Error(), errRb.Error()))
